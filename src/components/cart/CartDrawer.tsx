            ...
            >
                <header className="container" style={{ padding: '14px 0' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, justifyContent: 'space-between' }}>
                        <h3 style={{ margin: 0 }} className="drawer-title">Корзина</h3>
                        <button className="icon-btn animated-close-btn" aria-label="Закрыть корзину" onClick={()=>dispatch(closeDrawer())}>
                        ...
                        <div className="empty animated-empty">
                            <div className="empty-icon">
                                <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                                    <path d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m0 0h9m-9 0a2 2 0 100 4 2 2 0 000-4zm9 0a2 2 0 100 4 2 2 0 000-4z" stroke="currentColor" strokeWidth="1.5"/>
                                </svg>
                            </div>
                            <p>Корзина пуста</p>
