...
export default function WishlistPage() {
  ...
  const wishlistItems = useMemo(() => {
    ...
    console.log('WishlistPage: favorites IDs:', favorites);
    console.log('WishlistPage: snapshot from localStorage:', snapshot);
    ...
    const result = [...base, ...missing].map(p => ({ ...p, addedAt: new Date().toISOString() }));
    console.log('WishlistPage: final wishlist items:', result.length);
    return result;
